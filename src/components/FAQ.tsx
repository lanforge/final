...
const faqItems = [
  {
    ...
    answer: 'Standard shipping is 3‑5 business days within the continental US. Express shipping (1‑2 days) is available for an additional fee.'
  },
  {
    question: 'Can I upgrade components later?',
    answer: 'Yes! All our systems are built with upgradeability in mind. We offer upgrade services for existing customers at discounted rates.'
  },
  {
    question: 'What’s included in the warranty?',
    answer: 'Our 3‑year warranty covers all components against defects, plus free technical support. Accidental damage protection is available as an add‑on.'
  },
  {
    question: 'Do you offer international shipping?',
    answer: 'Yes, we ship to over 50 countries. Shipping costs and times vary by location. Contact our support team for a custom quote.'
  },
  {
    question: 'Can I customize the RGB lighting?',
    answer: 'Absolutely! Our systems feature fully customizable RGB with software control. You can sync lighting across all compatible components.'
  },
  {
    question: 'What if I need help setting up my PC?',
    answer: 'We provide detailed setup guides, video tutorials, and 24/7 live support. For an extra fee, we can even do a remote setup session.'
  }
];
