      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/customers/add" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-2">Customer Type</label>
                    <select
                      name="customerType"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Active Customers</div>
              <div className="text-2xl font-bold text-white">892</div>
              <div className="text-sm text-emerald-400 mt-2">71% active rate</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Avg. Order Value</div>
              <div className="text-2xl font-bold text-white">$1,248</div>
              <div className="text-sm text-emerald-400 mt-2">+12% from last month</div>
            </div>
          </div>
        </main>
      </div>
