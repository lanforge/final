...
const PCServicesPage: React.FC = () => {
  ...
  // Available PC services
  const services: Service[] = [
    {
      id: 'diagnostic',
      name: 'PC Diagnostic',
      description: 'Comprehensive system analysis to identify hardware and software issues',
      price: 49,
      duration: '1-2 hours',
      popular: true,
      icon: '🔍'
    },
    {
      id: 'cleaning',
      name: 'Deep Cleaning',
      description: 'Complete internal cleaning, dust removal, and thermal paste replacement',
      price: 79,
      duration: '2-3 hours',
      popular: false,
      icon: '🧹'
    },
    {
      ...
      description: 'Installation of new components (RAM, SSD, GPU, etc.)',
      price: 99,
      duration: '2-4 hours',
      popular: true,
      icon: '⚡'
    },
    {
      ...
      description: 'Clean Windows installation with drivers and essential software',
      price: 89,
      duration: '3-4 hours',
      popular: false,
      icon: '💻'
    },
    {
      id: 'virus',
      name: 'Virus Removal',
      description: 'Malware scanning, removal, and system security optimization',
      price: 69,
      duration: '1-2 hours',
      popular: false,
      icon: '🛡️'
    },
    {
      id: 'custom',
      name: 'Custom Build',
      description: 'Complete custom PC assembly with cable management',
      price: 149,
      duration: '4-6 hours',
      popular: true,
      icon: '🛠️'
    },
    {
      id: 'water',
      name: 'Water Cooling',
      description: 'Custom water cooling loop installation and maintenance',
      price: 299,
      duration: '6-8 hours',
      popular: false,
      icon: '💧'
    },
    {
      id: 'consultation',
      name: 'Consultation',
      description: 'One-on-one consultation for system optimization and upgrades',
      price: 39,
      duration: '1 hour',
      popular: false,
      icon: '💬'
