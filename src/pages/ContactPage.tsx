          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              <div className="card p-6 text-center">
                <div className="text-3xl font-bold text-gradient-neon mb-2">24h</div>
                <div className="text-gray-400">Response Time</div>
              </div>
              <div className="card p-6 text-center">
                <div className="text-3xl font-bold text-gradient-neon mb-2">7</div>
                <div className="text-gray-400">Days a Week</div>
              </div>
              <div className="card p-6 text-center">
              ...
              <div className="card p-6 text-center">
                <div className="text-3xl font-bold text-gradient-neon mb-2">Live</div>
                <div className="text-gray-400">Chat Support</div>
              </div>
            </div>
          </motion.div>
        </div>
