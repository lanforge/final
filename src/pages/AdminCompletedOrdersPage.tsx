...
const AdminCompletedOrdersPage: React.FC = () => {
  const orders = [
    { id: 'ORD-1001', customer: 'John Smith', date: '2026-03-03', total: '$1,299.99', items: 3, status: 'Completed' },
    { id: 'ORD-1004', customer: 'Emily Davis', date: '2026-03-02', total: '$2,899.99', items: 5, status: 'Completed' },
    { id: 'ORD-1006', customer: 'Michael Johnson', date: '2026-03-01', total: '$899.99', items: 2, status: 'Completed' },
    { id: 'ORD-1007', customer: 'Sarah Williams', date: '2026-02-28', total: '$3,499.99', items: 6, status: 'Completed' },
    { id: 'ORD-1013', customer: 'James Miller', date: '2026-02-22', total: '$1,199.99', items: 3, status: 'Completed' },
    { id: 'ORD-1014', customer: 'Patricia Brown', date: '2026-02-21', total: '$2,299.99', items: 4, status: 'Completed' },
    { id: 'ORD-1015', customer: 'Richard Jones', date: '2026-02-20', total: '$999.99', items: 2, status: 'Completed' },
    { id: 'ORD-1016', customer: 'Jennifer Garcia', date: '2026-02-19', total: '$1,899.99', items: 4, status: 'Completed' },
  ];
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/orders/completed" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="search-box">
                <input type="text" placeholder="Search completed orders..." className="search-input" />
          ...
          <div className="card p-6">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800">
              <div className="text-sm text-gray-400">Showing 1-8 of 28 completed orders</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Total Revenue (30 days)</div>
            ...
            <div className="card p-6">
              ...
              <div className="text-2xl font-bold text-white">$1,520.71</div>
            ...
            <div className="card p-6">
              ...
              <div className="text-sm text-emerald-400 mt-2">+0.3 from last month</div>
            </div>
          </div>
        </main>
      </div>
