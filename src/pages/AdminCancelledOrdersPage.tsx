...
const AdminCancelledOrdersPage: React.FC = () => {
  const orders = [
    { id: 'ORD-1017', customer: 'Thomas Wilson', date: '2026-02-18', total: '$2,199.99', items: 4, status: 'Cancelled', reason: 'Customer Request' },
    { id: 'ORD-1018', customer: 'Susan Martinez', date: '2026-02-15', total: '$1,499.99', items: 3, status: 'Cancelled', reason: 'Out of Stock' },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-400">Cancelled Orders</div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/orders/cancelled" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="search-box">
                <input type="text" placeholder="Search cancelled orders..." className="search-input" />
          ...
          <div className="card p-6">
                ...
                <tbody>
                  {orders.map((order) => (
                    <tr key={order.id} className="border-b border-gray-800/50 hover:bg-gray-800/30">
                      ...
                      <td className="py-3 px-4">
                        <div className="text-gray-400">{order.reason}</div>
                      </td>
                      <td className="py-3 px-4">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800">
              <div className="text-sm text-gray-400">Showing 1-2 of 2 cancelled orders</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Cancellation Rate (30 days)</div>
              <div className="text-2xl font-bold text-white">4.8%</div>
              <div className="text-sm text-emerald-400 mt-2">-1.2% from last month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Total Lost Revenue</div>
              <div className="text-2xl font-bold text-white">$3,699.98</div>
              <div className="text-sm text-red-400 mt-2">+$450 from last month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Most Common Reason</div>
              <div className="text-2xl font-bold text-white">Customer Request</div>
              <div className="text-sm text-gray-400 mt-2">50% of cancellations</div>
            </div>
          </div>
        </main>
      </div>
