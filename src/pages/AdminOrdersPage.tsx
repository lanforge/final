...
const AdminOrdersPage: React.FC = () => {
  const orders = [
    { id: 'ORD-1001', customer: 'John Smith', date: '2026-03-03', total: '$1,299.99', status: 'Completed', items: 3 },
    { id: 'ORD-1002', customer: 'Sarah Johnson', date: '2026-03-02', total: '$2,499.99', status: 'Processing', items: 5 },
    { id: 'ORD-1003', customer: 'Mike Wilson', date: '2026-03-02', total: '$899.99', status: 'Pending', items: 2 },
    { id: 'ORD-1004', customer: 'Emily Davis', date: '2026-03-01', total: '$1,799.99', status: 'Completed', items: 4 },
    { id: 'ORD-1005', customer: 'Robert Brown', date: '2026-03-01', total: '$3,199.99', status: 'Processing', items: 6 },
    { id: 'ORD-1006', customer: 'Lisa Miller', date: '2026-02-28', total: '$599.99', status: 'Cancelled', items: 1 },
    { id: 'ORD-1007', customer: 'David Garcia', date: '2026-02-28', total: '$1,099.99', status: 'Completed', items: 3 },
    { id: 'ORD-1008', customer: 'Jennifer Lee', date: '2026-02-27', total: '$2,199.99', status: 'Processing', items: 4 },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-400">Orders Management</div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/orders" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="card p-6">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800">
              <div className="text-sm text-gray-400">Showing 1-8 of 42 orders</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
            ...
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Orders This Month</div>
              <div className="text-2xl font-bold text-white">42</div>
              <div className="text-sm text-emerald-400 mt-2">+15.8% from last month</div>
            </div>
            <div className="card p-6">
