        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-400">Add Product</div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/products/add" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="card p-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">Product Description</label>
                <textarea
                  name="description"
            ...
            <div className="card p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="border-2 border-dashed border-gray-700 rounded-lg p-8 text-center hover:border-gradient-neon transition-colors">
