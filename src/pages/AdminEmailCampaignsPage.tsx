...
const AdminEmailCampaignsPage: React.FC = () => {
  return (
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/marketing/email" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Total Subscribers</div>
              <div className="text-2xl font-bold text-white">12,458</div>
              <div className="text-sm text-emerald-400 mt-2">+245 this month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Open Rate</div>
              <div className="text-2xl font-bold text-white">42.8%</div>
              <div className="text-sm text-emerald-400 mt-2">+3.2% from last month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Click Rate</div>
              <div className="text-2xl font-bold text-white">8.4%</div>
              <div className="text-sm text-emerald-400 mt-2">+1.1% from last month</div>
            </div>
            <div className="card p-6">
                ...
                <tbody>
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">Summer Sale 2026</div>
                      <div className="text-sm text-gray-400">Promotional</div>
                    </td>
                    <td className="py-3 px-4">
                    ...
                    <td className="py-3 px-4">
                      <div className="text-gray-400">12,458</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">42.8%</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">8.4%</div>
                    </td>
                    <td className="py-3 px-4">
                  ...
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">New Product Launch</div>
                    ...
                    <td className="py-3 px-4">
                      <div className="text-gray-400">10,248</div>
                    </td>
                    <td className="py-3 px-4">
                  ...
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">Weekly Newsletter</div>
                    ...
                    <td className="py-3 px-4">
                      <div className="text-gray-400">11,856</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">38.2%</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">6.8%</div>
                    </td>
                    <td className="py-3 px-4">
                      <button className="btn btn-ghost btn-sm">View</button>
                    </td>
          ...
          <div className="card p-6 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="form-input" placeholder="e.g., Summer Sale 2026" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" className="form-input" placeholder="e.g., Summer Sale - Up to 50% Off!" />
              </div>
              <div>
            ...
            <div className="mt-6">
              ...
              <textarea className="form-input h-48" placeholder="Enter your email content here..." />
            </div>
            <div className="mt-6">
