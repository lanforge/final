...
const AdminProductsPage: React.FC = () => {
  const products = [
    { id: 'PROD-001', name: 'LANForge Pro Gaming PC', category: 'Gaming PCs', price: '$2,499.99', stock: 42, status: 'Active', sales: 128 },
    { id: 'PROD-002', name: 'LANForge Elite Workstation', category: 'Workstations', price: '$3,799.99', stock: 18, status: 'Active', sales: 64 },
    { id: 'PROD-003', name: 'LANForge Mini Server', category: 'Servers', price: '$1,899.99', stock: 8, status: 'Low Stock', sales: 32 },
    { id: 'PROD-004', name: 'RGB Gaming Keyboard', category: 'Accessories', price: '$129.99', stock: 156, status: 'Active', sales: 256 },
    { id: 'PROD-005', name: '4K Gaming Monitor', category: 'Monitors', price: '$599.99', stock: 24, status: 'Active', sales: 96 },
    { id: 'PROD-006', name: 'Wireless Gaming Mouse', category: 'Accessories', price: '$89.99', stock: 0, status: 'Out of Stock', sales: 192 },
    { id: 'PROD-007', name: 'Gaming Headset Pro', category: 'Audio', price: '$199.99', stock: 36, status: 'Active', sales: 128 },
    { id: 'PROD-008', name: 'Streaming PC Bundle', category: 'Bundles', price: '$3,299.99', stock: 12, status: 'Active', sales: 48 },
  ];
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-400">Products Management</div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/products" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="card p-6">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-800">
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Product ID</th>
                  ...
                  {products.map((product) => (
                    <tr key={product.id} className="border-b border-gray-800/50 hover:bg-gray-800/30">
                      <td className="py-3 px-4">
                        <div className="font-medium text-white">{product.id}</div>
                      </td>
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4">
                        <div className="text-gray-400">{product.stock} units</div>
                      </td>
                      <td className="py-3 px-4">
                        <div className="text-gray-400">{product.sales} sold</div>
                      </td>
                      <td className="py-3 px-4">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800">
              <div className="text-sm text-gray-400">Showing 1-8 of 24 products</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
            ...
            <div className="card p-6">
              ...
              <div className="text-sm text-red-400 mt-2">+1 from last month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Low Stock</div>
              <div className="text-2xl font-bold text-white">5</div>
              <div className="text-sm text-yellow-400 mt-2">-2 from last month</div>
            </div>
            <div className="card p-6">
