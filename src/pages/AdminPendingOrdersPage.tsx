...
const AdminPendingOrdersPage: React.FC = () => {
  const orders = [
    { id: 'ORD-1002', customer: 'Sarah Johnson', date: '2026-03-02', total: '$2,499.99', items: 5, status: 'Processing' },
    { id: 'ORD-1003', customer: 'Mike Wilson', date: '2026-03-02', total: '$899.99', items: 2, status: 'Pending' },
    { id: 'ORD-1005', customer: 'Robert Brown', date: '2026-03-01', total: '$3,199.99', items: 6, status: 'Processing' },
    { id: 'ORD-1008', customer: 'Jennifer Lee', date: '2026-02-27', total: '$2,199.99', items: 4, status: 'Processing' },
    { id: 'ORD-1009', customer: 'Alex Thompson', date: '2026-02-26', total: '$1,499.99', items: 3, status: 'Pending' },
    { id: 'ORD-1010', customer: 'Maria Garcia', date: '2026-02-25', total: '$999.99', items: 2, status: 'Processing' },
    { id: 'ORD-1011', customer: 'David Chen', date: '2026-02-24', total: '$2,899.99', items: 5, status: 'Pending' },
    { id: 'ORD-1012', customer: 'Lisa Wong', date: '2026-02-23', total: '$1,799.99', items: 4, status: 'Processing' },
  ];
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/orders/pending" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="search-box">
                <input type="text" placeholder="Search pending orders..." className="search-input" />
          ...
          <div className="card p-6">
                ...
                <tbody>
                  {orders.map((order) => (
                    <tr key={order.id} className="border-b border-gray-800/50 hover:bg-gray-800/30">
                      ...
                      <td className="py-3 px-4">
                        <div className="text-gray-400">{order.items} items</div>
                      </td>
                      <td className="py-3 px-4">
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-800">
              <div className="text-sm text-gray-400">Showing 1-8 of 12 pending orders</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Average Processing Time</div>
              <div className="text-2xl font-bold text-white">2.4 days</div>
              <div className="text-sm text-emerald-400 mt-2">-0.5 days from last week</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Orders Requiring Attention</div>
              <div className="text-2xl font-bold text-white">4</div>
              <div className="text-sm text-emerald-400 mt-2">-2 from yesterday</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Total Pending Value</div>
              <div className="text-2xl font-bold text-white">$15,897.92</div>
              <div className="text-sm text-emerald-400 mt-2">+$2,450 from last week</div>
            </div>
          </div>
        </main>
      </div>
