...
const AdminLoyaltyPage: React.FC = () => {
  return (
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-400">Loyalty Program</div>
            </div>
            <div className="flex items-center gap-4">
        ...
        <aside className="w-64 bg-gray-900 border-r border-gray-800 min-h-[calc(100vh-73px)]">
          <nav className="p-4 space-y-1">
            ...
            <div className="sidebar-group">
              ...
              <a href="/admin/customers/loyalty" className="sidebar-item active">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Total Members</div>
              <div className="text-2xl font-bold text-white">892</div>
              <div className="text-sm text-emerald-400 mt-2">+42 this month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Active Points</div>
              <div className="text-2xl font-bold text-white">248,500</div>
              <div className="text-sm text-emerald-400 mt-2">+12,500 this month</div>
            </div>
            <div className="card p-6">
              <div className="text-sm text-gray-400 mb-2">Redeemed Rewards</div>
              <div className="text-2xl font-bold text-white">156</div>
              <div className="text-sm text-emerald-400 mt-2">+24 this month</div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-900/50 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-medium text-white">Bronze Tier</div>
                    <div className="text-sm text-gray-400">0-999 points • 5% discount</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-medium text-white">428 members</div>
                  <div className="text-sm text-gray-400">48% of total</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-900/50 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-medium text-white">Silver Tier</div>
                    <div className="text-sm text-gray-400">1,000-4,999 points • 10% discount</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-medium text-white">312 members</div>
                  <div className="text-sm text-gray-400">35% of total</div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-900/50 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-medium text-white">Gold Tier</div>
                    <div className="text-sm text-gray-400">5,000+ points • 15% discount</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-medium text-white">152 members</div>
                  <div className="text-sm text-gray-400">17% of total</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-800">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Points Used</th>
                ...
                <tbody>
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    ...
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">$50 Gift Card</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">5,000 points</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">Mar 5, 2026</div>
                    </td>
                    <td className="py-3 px-4">
                  ...
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    <td className="py-3 px-4">
                      ...
                      <div className="text-sm text-gray-400">sarah@example.com</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">Free Shipping</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">1,000 points</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">Mar 4, 2026</div>
                    </td>
                    <td className="py-3 px-4">
                      <span className="px-2 py-1 text-xs rounded-full bg-emerald-500/20 text-emerald-400">
                        Redeemed
                  ...
                  <tr className="border-b border-gray-800/50 hover:bg-gray-800/30">
                    <td className="py-3 px-4">
                      ...
                      <div className="text-sm text-gray-400">mike@example.com</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="font-medium text-white">10% Discount</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">2,500 points</div>
                    </td>
                    <td className="py-3 px-4">
                      <div className="text-gray-400">Mar 3, 2026</div>
                    </td>
                    <td className="py-3 px-4">
